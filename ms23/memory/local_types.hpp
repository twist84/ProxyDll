...
struct
{
	std::vector<s_vftable> Array
	{
		...
		{ 0x169F59C, 55, "c_saved_film_take_screenshot" },
		{ 0x169F7A4, 55, "c_saved_film_snippet_screen" },
		{ 0x169F8C4, 55, "c_error_dialog_screen_widget" },
		{ 0x169F9A4, 55, "c_error_dialog_ok_screen_widget" },
		{ 0x169FACC, 55, "c_gui_screen_alpha_motd" },
		{ 0x169FBAC, 4, "c_load_alpha_motd_screen_message" },
		{ 0x169FC10, 1, "c_http_stored_buffer_downloader<4665>" },
		{ 0x169FC1C, 55, "c_main_menu_screen_widget" },
		{ 0x169FCFC, 4, "c_load_campaign_select_difficulty_screen_message" },
		{ 0x169FD7C, 56, "c_start_menu_game_campaign" },
		{ 0x169FF1C, 56, "c_start_menu_game_multiplayer" },
		{ 0x16A008C, 56, "c_start_menu_game_editor" },
		{ 0x16A0174, 28, "c_gui_gametype_category_datasource" },
		{ 0x16A01E8, 4, "c_load_legal_screen_message" },
		{ 0x16A02C4, 56, "c_start_menu_game_saved_film" },
		{ 0x16A03E8, 1, "c_http_stored_buffer_downloader<2721>" },
		{ 0x16A03F0, 1, "c_http_stored_buffer_downloader<61440>" },
		{ 0x16A03FC, 56, "c_start_menu_headquarters" },
		{ 0x16A056C, 56, "c_gui_start_menu_hq_service_record_pane" },
		{ 0x16A0654, 56, "c_gui_start_menu_hq_service_record" },
		{ 0x16A073C, 28, "c_gui_start_menu_hq_service_record_insignia_datasource" },
		{ 0x16A0844, 56, "c_gui_start_menu_hq_service_record_file_share" },
		{ 0x16A0928, 4, "c_load_file_share_choose_category_screen_message" },
		{ 0x16A093C, 4, "c_load_file_share_choose_item_screen_message" },
		{ 0x16A0950, 4, "c_load_file_share_item_selected_screen_message" },
		{ 0x16A0964, 4, "c_load_transfers_item_selected_screen_message" },
		{ 0x16A097C, 28, "c_gui_file_share_slots_datasource" },
		{ 0x16A0ACC, 55, "c_gui_start_menu_hq_service_record_file_share_choose_category" },
		{ 0x16A0BEC, 55, "c_gui_start_menu_hq_service_record_file_share_choose_item" },
		{ 0x16A0CCC, 28, "c_gui_content_item_datasource" },
		{ 0x16A0E3C, 55, "c_gui_start_menu_hq_service_record_file_share_item_selected" },
		{ 0x16A0F1C, 4, "c_load_screenshots_file_share_previewer_screen_message" },
		{ 0x16A0F34, 28, "c_gui_file_share_selected_item_datasource" },
		{ 0x16A10B4, 56, "c_gui_start_menu_hq_screenshots" },
		{ 0x16A1198, 4, "c_load_screenshots_viewer_screen_message" },
		{ 0x16A11AC, 4, "c_load_hq_screenshots_options_screen_message" },		
		{ 0x16A11C4, 28, "c_player_screenshots_datasource" },
		{ 0x16A133C, 55, "c_gui_start_menu_hq_screenshots_options" },
		{ 0x16A14F4, 57, "c_screenshots_screen_widget_base" },
		{ 0x16A15DC, 57, "c_screenshots_viewer_screen_widget" },
		{ 0x16A16C4, 1, "c_http_stored_buffer_downloader<317440>" },
		{ 0x16A16CC, 57, "c_screenshots_file_share_previewer_screen_widget" },
		{ 0x16A1824, 56, "c_gui_start_menu_hq_transfers" },
		{ 0x16A190C, 28, "c_active_transfers_datasource" },
		{ 0x16A19C4, 55, "c_gui_start_menu_hq_transfers_item_selected" },
		{ 0x16A1AA4, 28, "c_gui_transfers_selected_item_datasource" },
		{ 0x16A1B5C, 56, "c_start_menu_settings" },
		{ 0x16A1C84, 56, "c_start_menu_settings_controls" },
		{ 0x16A1D6C, 28, "c_settings_controls_sidebar_items_datasource" },
		{ 0x16A1E94, 56, "c_start_menu_settings_controls_button" },
		{ 0x16A1FBC, 56, "c_start_menu_settings_controls_thumbstick" },
		{ 0x16A20E4, 56, "c_start_menu_settings_appearance" },
		{ 0x16A22CC, 56, "c_start_menu_settings_appearance_model" },
		{ 0x16A23B4, 28, "c_model_customization_selections_datasource" },				
		{ 0x16A242C, 28, "c_settings_appearance_model_sidebar_items_datasource" },
		{ 0x16A2554, 56, "c_start_menu_settings_appearance_colors" },
		{ 0x16A263C, 39, "c_color_swatch_focus_list_item_widget" },
		{ 0x16A27B4, 56, "c_start_menu_settings_camera" },
		{ 0x16A289C, 28, "c_settings_camera_sidebar_items_datasource" },
		{ 0x16A298C, 56, "c_start_menu_settings_display" },
		{ 0x16A2A74, 28, "c_settings_display_sidebar_items_datasource" },
		{ 0x16A2B64, 56, "c_start_menu_settings_film_autosave" },
		{ 0x16A2C4C, 28, "c_settings_film_autosave_sidebar_items_datasource" },
		{ 0x16A2D4C, 55, "c_gui_screen_in_progress" },
		{ 0x16A2E6C, 55, "c_gui_spartan_milestone" },
		{ 0x16A2F8C, 55, "c_gui_spartan_rank" },
		{ 0x16A30B4, 55, "c_gui_screen_campaign_select_difficulty" },
		{ 0x16A31DC, 55, "c_gui_screen_campaign_select_level" },
		{ 0x16A32BC, 10, "c_gui_level_selected_item" },
		{ 0x16A32EC, 29, "c_gui_survival_level_datasource" },
		{ 0x16A3434, 55, "c_gui_screen_campaign_select_scoring" },
		{ 0x16A35DC, 55, "c_gui_screen_campaign_select_skulls" },				
		{ 0x16A36BC, 28, "c_gui_primary_skulls_data" },
		{ 0x16A3734, 28, "c_gui_secondary_skulls_data" },
		{ 0x16A37F0, 1, "c_gui_screen_pregame_lobby_campaign" },
		{ 0x16A38F4, 4, "c_load_campaign_select_level_screen_message" },
		{ 0x16A39DC, 63, "c_gui_screen_pregame_lobby_survival" },
		{ 0x16A3B24, 63, "c_gui_screen_pregame_lobby_multiplayer" },
		{ 0x16A3CCC, 1, "c_http_stored_buffer_downloader<2465>" },
		{ 0x16A3CD4, 1, "c_http_stored_buffer_downloader<102400>" },
		{ 0x16A3CDC, 63, "c_gui_screen_pregame_lobby_matchmaking" },
		{ 0x16A3EF4, 63, "c_gui_screen_pregame_lobby_mapeditor" },
		{ 0x16A4064, 63, "c_gui_screen_pregame_lobby_theater" },
		{ 0x16A4234, 55, "c_gui_screen_pregame_switch_lobby" },
		{ 0x16A435C, 55, "c_gui_screen_pregame_selection" },
		{ 0x16A453C, 55, "c_gui_screen_matchmaking_advanced_options" },
		{ 0x16A470C, 55, "c_gui_screen_postgame_lobby" },
		{ 0x16A4870, 4, "c_load_player_select_screen_message" },
		{ 0x16A4884, 55, "c_gui_player_select_screen_widget" },
		{ 0x16A4964, 28, "c_player_select_actions_datasource" },		
		{ 0x16A49DC, 28, "c_player_select_medals_datasource" },
		{ 0x16A4D2C, 55, "c_gui_screen_maximum_party_size" },
		{ 0x16A4E4C, 4, "c_load_game_details_screen_message" },
		{ 0x16A4E64, 55, "c_gui_game_details" },
		{ 0x16A4F44, 29, "c_specific_game_info_datasource" },
		{ 0x16A5004, 4, "c_load_game_options_screen_message" },
		{ 0x16A501C, 55, "c_gui_screen_game_options" },
		{ 0x16A50FC, 28, "c_game_options_parameter_datasource" },
		{ 0x16A5174, 28, "c_game_options_category_datasource" },
		{ 0x16A52EC, 55, "c_gui_screen_alpha_legal" },
		{ 0x16A540C, 55, "c_gui_screen_alpha_locked_down" },
		{ 0x16A5534, 55, "c_gui_screen_forge_legal" },
		{ 0x16A5654, 55, "c_gui_screen_matchmaking_searching" },
		{ 0x16A591C, 55, "c_gui_screen_matchmaking_match_found" },
		{ 0x16A5E34, 55, "c_motd_popup_screen_widget" },
		{ 0x16A5F6C, 38, "c_gui_group_widget" },
		{ 0x16A600C, 39, "c_gui_button_key_widget" },
		{ 0x16A60EC, 38, "c_gui_list_widget" },		
		{ 0x16A61CC, 41, "c_gui_bitmap_widget" },
		{ 0x16A62F4, 39, "c_gui_list_item_widget" },
		{ 0x16A63D4, 43, "c_gui_text_widget" },
		{ 0x16A6564, 38, "c_gui_model_widget" },
		{ 0x16A6684, 29, "c_gui_game_results_data" },
		{ 0x16A66FC, 28, "c_gui_game_results_team_data" },
		{ 0x16A6774, 28, "c_gui_top_medals_data" },
		{ 0x16A685C, 28, "c_gui_campaign_results_data" },
		{ 0x16A6910, 3, "c_html_comment_game_tag_parser" },
		{ 0x16A6920, 3, "c_html_line_break_game_tag_parser" },
		{ 0x16A6930, 3, "c_html_paragraph_game_tag_parser" },
		{ 0x16A6940, 3, "c_html_paragraph_close_game_tag_parser" },
		{ 0x16A6950, 3, "c_html_div_game_tag_parser" },
		{ 0x16A6960, 3, "c_html_div_close_game_tag_parser" },
		{ 0x16A6970, 3, "c_html_font_game_tag_parser" },
		{ 0x16A6980, 3, "c_html_font_close_game_tag_parser" },
		{ 0x16A6990, 3, "c_color_game_tag_parser" },
		{ 0x16A69A0, 3, "c_color_close_game_tag_parser" },				
		{ 0x16A6BE0, 3, "c_start_menu_custom_message" },
		{ 0x16A6BF4, 56, "c_start_menu_pane_screen_widget" },
		{ 0x16A6D9C, 28, "c_gui_level_category_datasource" },
		{ 0x16A6E14, 29, "c_gui_level_subitem_selectable_item_datasource" },
		{ 0x16A6ECC, 55, "c_gui_screen_campaign_settings" },
		{ 0x16A6FF4, 63, "c_gui_screen_pregame_lobby" },
		{ 0x16A7384, 10, "c_gui_network_mode_selected_item" },		
		{ 0x16A73B4, 28, "c_gui_network_mode_category_datasource" },
		{ 0x16A742C, 29, "c_gui_network_mode_subitem_selectable_item_datasource" },		
		{ 0x16A74E4, 10, "c_gui_hopper_selected_item" },
		{ 0x16A7514, 28, "c_gui_hopper_category_datasource" },
		{ 0x16A758C, 29, "c_gui_hopper_subitem_selectable_item_datasource" },
