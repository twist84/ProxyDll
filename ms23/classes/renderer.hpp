...
bool __cdecl IDirect3DIndexBuffer9__SetIndexData(IDirect3DIndexBuffer9 *pIndexData) // 00A233C0
{
...
int __cdecl IDirect3DDevice9__RenderStateFillModeSetValue(DWORD Value) // 00A233A0
{
	return (*g_IDirect3DDevice9)->SetRenderState(D3DRS_FILLMODE, Value);
}
bool __cdecl IDirect3DDevice9__PixelShaderSet(IDirect3DPixelShader9 *pShader) // 00A23500
{
...
bool __cdecl IDirect3DDevice9__VertexShaderSet(IDirect3DVertexShader9 *pShader) // 00A247B0
{
...
int __cdecl IDirect3DDevice9__DepthStencilSurfaceSetZ(IDirect3DSurface9 *pNewZStencil) // 00A48C70
{
...
HRESULT __cdecl IDirect3DDevice9__CreateDepthStencilSurface(UINT Width, UINT Height, D3DFORMAT Format, int a4, DWORD MultisampleQuality, BOOL Discard, IDirect3DSurface9 **ppSurface) // 00A75A00
{
...
int Direct3DDevice9__SetViewport_hook(Rect<int16_t>* rect, float MinZ, float MaxZ)
{
...
inline void AddRendererHooks(const char *name)
{
	if (ConfigManager.GetBool("Hooks", name))
	{
		...
		//HookManager.AddHook({ 0x6233A0 }, &IDirect3DDevice9__RenderStateFillModeSetValue, "IDirect3DDevice9::RenderStateFillModeSetValue");
		//HookManager.AddHook({ 0x6233C0 }, &IDirect3DIndexBuffer9__SetIndexData, "IDirect3DIndexBuffer9::SetIndexData");
		//HookManager.AddHook({ 0x623500 }, &IDirect3DDevice9__PixelShaderSet, "IDirect3DDevice9::PixelShaderSet");
		...
		//HookManager.AddHook({ 0x6247B0 }, &IDirect3DDevice9__VertexShaderSet, "IDirect3DDevice9::VertexShaderSet");
		//HookManager.AddHook({ 0x648C70 }, &IDirect3DDevice9__DepthStencilSurfaceSetZ, "IDirect3DDevice9::DepthStencilSurfaceSetZ");
		HookManager.AddHook({ 0x649010 }, &Direct3DDevice9__SetViewport_hook, "Direct3DDevice9::SetViewport");
		...
		//HookManager.AddHook({ 0x675A00 }, &IDirect3DDevice9__CreateDepthStencilSurface, "IDirect3DDevice9::CreateDepthStencilSurface");
